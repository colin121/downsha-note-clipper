...
Downsha.DownshaError.prototype.getClassName = function() {
  return (typeof this.constructor[Downsha.DownshaError.CLASS_FIELD] != 'undefined') ? 
  	this.constructor[Downsha.DownshaError.CLASS_FIELD] : null;
};
 ...
 */
Downsha.DSTPSystemException = function DSTPSystemException(errorCodeOrObj,
    message) {
 ...
 */
Downsha.DSTPUserException = function DSTPUserException(errorCodeOrObj,
    message, parameter) {
  this.initialize(errorCodeOrObj, message, parameter);
};
...
/**
 * Downsha.DSTPResponseException holds various errors associated with actual
 ...
 * @return
 */
Downsha.DSTPResponseException = function DSTPResponseException(errorCodeOrObj,
    message) {
  this.initialize(errorCodeOrObj, message);
};
...
/**
 * Downsha.DSTPScopedError is like a Downsha.ScopedLocalizableError but is
 * bound to Downsha.DSTPErrorCode's. These are typically included in a response
 ...
 * @return
 */
Downsha.DSTPScopedError = function DSTPScopedError(errorCodeOrObj, message,
    parameter) {
  this.initialize(errorCodeOrObj, message, parameter);
};
