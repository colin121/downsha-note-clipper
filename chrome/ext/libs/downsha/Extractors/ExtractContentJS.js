...
ExtractContentJS.Lib.DOM = (function () {
    ...
    b.matchTag = function (d, c) {
        return a.some(c, function (e) {
            if (typeof e == "string") {
                return e == (d.tagName || "").toLowerCase()
            } else {
                if (e instanceof Array) {
                    return e[0] == (d.tagName || "").toLowerCase() && b.matchAttr(d, e[1])
                } else {
                    return false
                }
            }
